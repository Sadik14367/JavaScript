                        ...
                        <div class="col-12 col-md-8">
                            <div class="row">
                                <div class="col-lg-12 col-12">
                                    <!-- Lead News (Top Big Post) -->
                                    <div class="lead_heaight mb-3">
                                        <div class="common-border-box">
                                            <div class="lead-news topfirst-leadnews" id="lead-news">
                                                <?php
                                                global $codedokan;
                                                // First category for lead news
                                                $lead_category = !empty($codedokan['home_lead_selected']) ? $codedokan['home_lead_selected'] : 1;
                                    ...
                                    <!-- 2nd Lead News (6 Posts Grid) -->
                                    <div class="common-border-box mt-3 mb-3">
                                        <div class="row sub-news">
                                            <?php
                                            // Second category for the 6 posts
                                            $second_lead_category = !empty($codedokan['home_2ndlead_selected']) ? $codedokan['home_2ndlead_selected'] : 1;

                                            $args = array(
                                                'posts_per_page' => 6,
                                                'order' => 'DESC', 
                                                'cat' => $second_lead_category
                                            );
                                            ...
                                            if ($sub_posts->have_posts()) : 
                                                        ...
                                                        <div class="common-card-content position-relative">
                                                            ...
                                                            <div class="news-content-box">
                                                                <div class="position-relative">
                                                                    <h5 class="title"><?php echo wp_trim_words(get_the_title(), 5, '...'); ?></h5>
                                                                    <a class="link" href="<?php the_permalink(); ?>"></a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <p>No posts found in second lead category</p>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
